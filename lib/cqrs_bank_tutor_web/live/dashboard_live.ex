defmodule CqrsBankTutorWeb.DashboardLive do
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, accounts: list_accounts(), transfers: list_transfers())}
  end
  ...
  defp refresh(socket), do: assign(socket, accounts: list_accounts(), transfers: list_transfers())
      ...
      <div class="max-w-5xl mx-auto py-8 space-y-8">
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <div class="space-y-4">
            ...
            <ul class="divide-y divide-zinc-200 rounded-md border">
              <%= for a <- @accounts do %>
